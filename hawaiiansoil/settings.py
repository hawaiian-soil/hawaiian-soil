"""
Django settings for hawaiiansoil project.
...
SECRET_KEY = '$e9t$opg5byvg-#1t$wialfp7x$amz6%%nu%(7+qvktwwg5#n2'
...
ROOT_URLCONF = 'hawaiiansoil.urls'
...
WSGI_APPLICATION = 'hawaiiansoil.wsgi.application'
